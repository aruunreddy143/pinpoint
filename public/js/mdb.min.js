...
angular.module('ui.bootstrap.demo').controller('TypeaheadCtrl', function($scope, $http) {
  ...
  $scope.locateMe=function(points) {
  	console.log(points);

  	$scope.mapContainer=true;
    
  	/*$(".pinpointMap").googleMap();
    
    $(".pinpointMap").addMarker({
      coords: [points.location[0], points.location[1]],
      setZoom:1
       });*/

    var myCenter = new google.maps.LatLng(points.location[0],points.location[1]);
  var mapCanvas = document.getElementById("pinpointMap");
  ...
  "city": "BENGALURU",
  "pinpoint": "AD7D - 1AB",
  "searchData": "691, 15TH CROSS, 2ND PHASE, AD7D - 1AB",
  "location":['12.910961', '77.586287']
},
{
  "id": 2,
  "no": 692,
  ...
  "city": "BENGALURU",
  "pinpoint": "AD7D - 2AB",
  "searchData": "692, 15TH CROSS, 2ND PHASE AD7D - 1AB",
  "location":["12.911536", "77.585407"]
},
{
  "id": 3,
  "no": 693,
  ...
  "city": "BENGALURU",
  "pinpoint": "AD7D - 2AB",
  "searchData": "693, 15TH CROSS, 2ND PHASE AD7D - 1AB",
  "location":['12.910961', '77.586287']
},
{
  "id": 3,
  ...
  "city": "BENGALURU",
  "pinpoint": "AD7D - 2AB",
  "searchData": "700, 15TH CROSS, 24TH MAIN, AD7D - 1AB",
  "location":['12.910961', '77.586287']
},
{
  "id": 4,
  ...
  "city": "BENGALURU",
  "pinpoint": "AD7D - 2AB",
  "searchData": "701, 14TH CROSS, 24TH MAIN, AD7D - 2AB",
  "location":['12.910961', '77.586287']
},{
  "id": 4,
  "no": 822,
  ...
  "city": "BENGALURU",
  "pinpoint": "AD7D - 1AC",
  "searchData": "822, 14TH CROSS, 24TH MAIN, AD7D - 1AC",
  "location":['12.910961', '77.586287']
},
{
  "id": 5,
  ...
  "city": "BENGALURU",
  "pinpoint": "AD7D - 1AD",
  "searchData": "740, 14TH CROSS, 24TH MAIN, AD7D - 1AD",
  "location":['12.910961', '77.586287']
}
  ]
...
.filter('listfilter',[ function () {
    return function(items, searchText) {
        ...
        searchText=searchText.toLowerCase().replace(/\s*,\s*/g, ',').split(',');
        //var regex = new RegExp(".*" + searchText + ".*", "ig");
        angular.forEach(items, function(item) {
        	var dataSearch=item.searchData.replace(/\s*,\s*/g, ',').split(',');
        	angular.forEach(dataSearch,function(value, key) {	
        		//angular.forEach(searchText,function(value, key) {			
					if( dataSearch[key].toLowerCase().startsWith(searchText[0]))  {
